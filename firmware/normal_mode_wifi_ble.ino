/*
 Project: Selective Signal Jammer for Civilian Applications
 Mode: Normal Mode (Wi-Fi + BLE)
 
 This firmware is provided for academic demonstration purposes only.
 Selective mode logic is under controlled development and not fully published.
 
 Hackathon: Codeversity National Level Hackathon 2026
 Team: Team Diamonds
 */
